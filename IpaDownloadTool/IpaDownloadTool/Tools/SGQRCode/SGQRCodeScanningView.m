...
#pragma mark - - - 扫描边角imageView的创建
    ...
    UIImage *left_image = [UIImage imageThemeNamed:@"SGQRCode.bundle/QRCodeLeftTop"];
    ...
    // 右上侧的image
    UIImage *right_image = [UIImage imageThemeNamed:@"SGQRCode.bundle/QRCodeRightTop"];
    ...
    // 左下侧的image
    UIImage *left_image_down = [UIImage imageThemeNamed:@"SGQRCode.bundle/QRCodeLeftBottom"];
    ...
    // 右下侧的image
    UIImage *right_image_down = [UIImage imageThemeNamed:@"SGQRCode.bundle/QRCodeRightBottom"];
...
- (UIImageView *)scanningline {
    if (!_scanningline) {
        ...
        _scanningline.image = [UIImage imageThemeNamed:@"SGQRCode.bundle/QRCodeScanningLine"];
